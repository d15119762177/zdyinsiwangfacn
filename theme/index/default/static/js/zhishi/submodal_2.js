		...
		'<div id="popupInner">' +
			'<div id="popupTitleBar">' +
				...
				'<div id="popupControls">' +
					'<span onclick="hidePopWin(true);" id="popCloseBox" style="background:url(/static/images/new_yz_jl_bg.png) no-repeat 0 -297px;width:32px;height:32px;display:block;"></span> ' +
				'</div>' +
			'</div>' +
...
function setNavBarNo(s_id)
{
	jQuery('#top'+s_id).addClass("currentno");
}
