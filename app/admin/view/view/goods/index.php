...
<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="{:url('admin/Goods/edit')}?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
    <a href="{:url('admin/Goods/del')}?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
</script>
<script type="text/javascript">
    ...
    layui.use(['table'], function() {
        ...
        table.render({
            elem: '#dataTable'
            ,url: "{:url('admin/Goods/index')}?search="+search //数据接口
            ,page: true //开启分页
            ,limit: 10
            ,search:search
            ,text: {
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'name', title: '网页',  width: '20%',sort: true}
                ,{field: 'title', title: '标题', width: '20%'}
                ,{field: 'intro', title: '标题详情',  width: '20%',sort: true}
                ,{title: '操作', width: 120, templet: '#buttonTpl', width: '20%'}
            ]]
        });
    });
</script>