...
<form class="layui-form layui-form-pane" action="{:url('admin/Company/add')}" id="editForm" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="name" lay-verify="title" autocomplete="off" placeholder="请输入公司名" style="width:300px;">
        </div>
