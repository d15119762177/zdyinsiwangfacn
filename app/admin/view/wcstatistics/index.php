...
<script type="text/html" title="操作按钮模板" id="buttonTpl">
    ...
    <a href="{:url('admin/wcstatistics/code')}?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">统计代码</a>
...
<script type="text/javascript">
    ...
    layui.use(['table'], function() {
        ...
        table.render({
            elem: '#dataTable'
            ,url: "{:url('admin/wcstatistics/index')}?search="+search //数据接口
            ,page: true //开启分页
            ,limit: 10
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'title', title: '事件    ',  width: '20%',sort: true}
                ,{field: 'number', title: '转化数',  width: '20%',sort: true}
