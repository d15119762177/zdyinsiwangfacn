<div class="page-toolbar">
    <div class="layui-btn-group fl">
        <a href="{:url('admin/domainname/wechatadd')}?urlid={$urlid}" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加微信号</a>
        <a data-href="{:url('admin/domainname/wechatdel')}" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
        ...
        <form class="layui-form layui-form-pane" action="{:url('admin/Goods/index')}" method="get">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="text" name="urlid" lay-verify="required"  autocomplete="off" class="layui-input" value="{$urlid}" style="display:none;">
                </div>
            </div>
        </form>
    </div>
...
<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="{:url('admin/domainname/wechatedit')}?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
    <a href="{:url('admin/domainname/wechatdel')}?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
</script>
<script type="text/javascript">
    ...
    layui.use(['table'], function() {
        ...
        table.render({
            elem: '#dataTable'
            ,url: "{:url('admin/Domainname/wechat')}?urlid="+urlid+"&search="+search //数据接口
            ,page: true //开启分页
            ,limit: 10
            ,search:search
            ,text: {
            ...
            ,cols: [[ //表头
               ...
               ,{field: 'username', title: '微信名称',  width: '20%',sort: true}
                ,{field: 'url', title: '图片url', width: '40%'}
