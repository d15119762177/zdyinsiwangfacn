...
<form class="layui-form layui-form-pane" action="{:url('admin/domainname/wechatedit')}" id="editForm" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="name" lay-verify="title" autocomplete="off" placeholder="请输入微信号" style="width:300px;" value="{$data.name}">
        </div>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="username" lay-verify="title" autocomplete="off" placeholder="请输入用户名称" style="width:300px;"value="{$data.username}">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            <button type="button" name="url" class="layui-btn layui-btn-primary layui-upload-image" lay-type="image" lay-data="{accept:'image'}">{if condition=" $data['url'] eq '' "}请上传二维码{else}修改二维码{/if}</button>
            <input type="hidden" class="upload-input" name="url" value="{$data.url}">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <input type="text"  name="urlid" value="{$data.urlid}" style="display:none;">
            <button type="submit" class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSubmit">提交</button>
            <a href="{:url('admin/domainname/wechat')}?id={$data.urlid}" class="layui-btn layui-btn-primary ml10"><i class="aicon ai-fanhui"></i>返回</a>
        </div>
    </div>
