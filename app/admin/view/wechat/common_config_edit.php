...
<form class="layui-form layui-form-pane" action="{:url('admin/Goods/common_config_edit')}" id="editForm" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="qq" lay-verify="title" autocomplete="off" placeholder="请输入标题" style="width:300px;" value="{$info.qq}">
        </div>
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-input-inline" style="z-index: 999;">
            <input type="text" class="layui-input field-username" name="phone" lay-verify="title" autocomplete="off" placeholder="请输入标题" style="width:300px;" value="{$info.phone}">
        </div>
    </div>
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-input-inline" style="z-index: 999;">
            <textarea name="address" id="" cols="50" rows="30">{$info.address}</textarea>
        </div>
    </div>
