<div class="page-toolbar">
    <div class="layui-btn-group fl">
        <a href="{:url('wechatadd?group='.input('param.group'))}" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加</a>
        <a data-href="{:url('admin/wechat/wechatdel')}" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
...
<script type="text/javascript">
    ...
    layui.use(['table'], function() {
        ...
        table.render({
            elem: '#dataTable'
            ,url: "{:url('admin/wechat/wechat')}?urlid="+urlid+"&search="+search //数据接口
            ,page: true //开启分页
            ,limit: 10
            ,search:search
            ,text: {
