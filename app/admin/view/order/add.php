...
<form class="layui-form layui-form-pane" action="{:url('admin/Order/add')}" id="editForm" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="applicant" lay-verify="required|username" autocomplete="off" placeholder="请输入投保人" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="insurant" lay-verify="required|username" autocomplete="off" placeholder="请输入受保人" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="quota" lay-verify="required|money" autocomplete="off" placeholder="请输入投保额度" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" id="paymenTime" name="paymenTime" lay-verify="title" autocomplete="off" placeholder="请输入缴费时间" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="premium" lay-verify="required|money" autocomplete="off" placeholder="请输入首年保费" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" id="startTime" name="startTime" lay-verify="title" autocomplete="off" placeholder="请输入保险生效时间" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" id="endTime" name="endTime" lay-verify="title" autocomplete="off" placeholder="请输入保险失效时间" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="remark" lay-verify="title" autocomplete="off" placeholder="请输入备注" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="fileId" lay-verify="title" autocomplete="off" placeholder="请输入关联文件表ID" style="width:300px;">
        </div>
        <!-- <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
    </div>
